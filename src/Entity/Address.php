 ...
 * Address
 *
 * @ORM\Table(name="address", indexes={@ORM\Index(name="idx_fk_city_id", columns={"city_id"}), @ORM\Index(name="idx_location", columns={"location"})})
...
class Address
{
     ...
     * @var geometry
     *
     * @ORM\Column(name="location", type="geometry", nullable=false)
     */
    private $location;
